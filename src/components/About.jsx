        ...
        <div className="px-4 lg:px-14 max-w-screen-2x1 mx-auto my-8" id="about"> 
            <div className="md:w-11/12 mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
                ...
                <div className="md:w-3/5 mx-auto">
                    ...
                    <p className="md:w-3/4 text-sm text-neutralGrey mb-8">Discover the untold stories and transformative experiences that shaped three remarkable years at Kantijaya.</p>
        ...
        <div className="px-4 lg:px-14 max-w-screen-2x1 mx-auto bg-neutralSilver py-16">
            <div className="flex flex-col md:flex-row justify-between items-center gap-8">
                ...
                <h2 className="text-4xl text-neutralGrey font-semibold mb-4 md:w-2/3">
                    ...
                    <p className="text-neutralGrey">Empowering local businesses to adapt, grow, and thrive with innovative solutions that drive success.</p>
                </div>
                {/* stats */}
                <div className="md:w-1/2 mx-auto flex sm:flex-row flex-col sm:items-center justify-around gap-30">
                    <div className="space-y-8">
                        <div className="flex items-center gap-4">
                            <img src="/src/assets/icons/member.png" alt="" className="w-14 h-auto"/>
                            <div>
                        ...
                        <div className="flex items-center gap-4">
                            <img src="/src/assets/icons/groups.png" alt="" className="w-14 h-auto"/>
                            <div>
                    ...
                    <div className="space-y-8">
                    <div className="flex items-center gap-4">
                            <img src="/src/assets/icons/eventbooking.png" alt="" className="w-14 h-auto"/>
                            <div>
                        ...
                        <div className="flex items-center gap-4">
                            <img src="/src/assets/icons/payment.png" alt="" className="w-14 h-auto"/>
                            <div>
